...
var _user$project$Components_Task$Model = F2(
	function (a, b) {
		return {description: a, editing: b};
	});
var _user$project$Components_Task$Remove = {ctor: 'Remove'};
var _user$project$Components_Task$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'StartEditing':
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Maybe$Just(_user$project$Components_Task$Remove)
				};
		}
	});
var _user$project$Components_Task$RemoveSelf = {ctor: 'RemoveSelf'};
var _user$project$Components_Task$Edit = function (a) {
		...
		switch (_p0.ctor) {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							tasks: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: model.nextID, _1: _user$project$Components_Task$init},
								_1: model.tasks
							},
			...
			case 'TaskMsg':
				var updateTask = function (_p1) {
					...
					var _p3 = {
						...
						_1: A2(_user$project$Components_Task$update, _p0._1, _p5)
					};
					if (_p3._0 === false) {
						return _elm_lang$core$Maybe$Just(
							{ctor: '_Tuple2', _0: _p4, _1: _p5});
					} else {
						if (_p3._1._1.ctor === 'Just') {
							return _elm_lang$core$Maybe$Nothing;
						} else {
							return _elm_lang$core$Maybe$Just(
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Maybe$Just(_user$project$Components_Section$Remove)
				};
		}
	});
var _user$project$Components_Section$RemoveSelf = {ctor: 'RemoveSelf'};
var _user$project$Components_Section$TaskMsg = F2(
	function (a, b) {
		return {ctor: 'TaskMsg', _0: a, _1: b};
	});
var _user$project$Components_Section$viewTask = function (_p6) {
	var _p7 = _p6;
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Components_Section$TaskMsg(_p7._0),
		_user$project$Components_Task$view(_p7._1));
};
...
var _user$project$Components_Board$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'Insert') {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						sections: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: model.nextID, _1: _user$project$Components_Section$init},
							_1: model.sections
						},
						nextID: model.nextID + 1
					}),
			...
			var updateSection = function (_p1) {
				var _p2 = _p1;
				var _p5 = _p2._1;
				var _p4 = _p2._0;
				var _p3 = {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.eq(_p4, _p0._0),
					_1: A2(_user$project$Components_Section$update, _p0._1, _p5)
				};
				if (_p3._0 === false) {
					return _elm_lang$core$Maybe$Just(
						{ctor: '_Tuple2', _0: _p4, _1: _p5});
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						sections: A2(_elm_lang$core$List$filterMap, updateSection, model.sections)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
...
var _user$project$Components_Board$Model = F3(
	function (a, b, c) {
		return {title: a, sections: b, nextID: c};
	});
var _user$project$Components_Board$SectionMsg = F2(
	function (a, b) {
		return {ctor: 'SectionMsg', _0: a, _1: b};
	});
var _user$project$Components_Board$viewSection = function (_p6) {
	var _p7 = _p6;
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Components_Board$SectionMsg(_p7._0),
		_user$project$Components_Section$view(_p7._1));
};
...
var _user$project$Components_Board$view = function (model) {
	...
	var insert = A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Add Section'),
			_1: {ctor: '[]'}
		});
	return A2(
		_elm_lang$html$Html$div,
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Components_Board$init, _1: _elm_lang$core$Platform_Cmd$none},
